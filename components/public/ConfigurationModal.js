    ...
    <div>
      <Modal isOpen={modalProp} toggle={toggle}>
        <ModalHeader toggle={toggle} className="d-flex flex-columns border-none bg-brand-primary text-white">
          <span className="font-weight-bold h3">Welcome to Culinaid</span>
        </ModalHeader>
        <ModalBody className="py-4">
          ...
          <p>{`Thank you for downloading Culinaid and getting started with NCR's APIs. In order for this application to run, there are a couple tasks that need to be completed.`}</p>
          <p>
